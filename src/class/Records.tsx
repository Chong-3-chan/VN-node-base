...
export class PackageInfo implements PackageInfoLike {
  ...
  constructor(...args: any[]) {
    if (args.length === 1) {
      ...
      return;
    } else if (args.length === 3 && typeof args[0] === 'string' && typeof args[1] === 'string' && args[2] instanceof Object) {
...
export class FileInfo {
  ...
  constructor(key: string, fromPackage: string, fileName: string, inDB?: boolean) {
    ...
    if (suffix in GetZip.fileSuffixMap) this.base64_type = GetZip.fileSuffixMap[suffix as GetZip.FileSuffix];
